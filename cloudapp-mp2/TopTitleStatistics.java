...
// <<< Don't Change
    ...
    public static class TitleCountMap extends Mapper<Object, Text, Text, IntWritable> {
        ...
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
            ...
            while (tokenizer.hasMoreTokens()) {
                ...
                if (!stopWords.contains(nextToken.trim())) {
    ...
    public static class TopTitlesStatMap extends Mapper<Text, Text, NullWritable, TextArrayWritable> {
        Integer N;
        TreeSet<Pair<Integer,String>> wordsByCount = new TreeSet<>();
        ...
        public void map(Text key, Text value, Context context) throws IOException, InterruptedException {
            ...
            wordsByCount.add(new Pair<Integer, String>(count, word));

            if (wordsByCount.size() > this.N) {
                wordsByCount.remove(wordsByCount.first());
            }
        }

        @Override
        protected void cleanup(Context context) throws IOException, InterruptedException {
            for (Pair<Integer, String> item : wordsByCount) {
